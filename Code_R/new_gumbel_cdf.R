...
gofC = gofCopula(gumbelCopula(dim=3, use.indepC="FALSE"), U, method="Sn",estim.method ="itau")

# para_gof = matrix(c(1.49, 17.3, 5e-04), nrow = 1, ncol = 3)
# 
# dimnames(para_gof) = list(c(""), c("parameter", "Statistic", "p-value"))
# 
# write.csv(para_gof, "para_gof_gumbel_cdf.csv")
...
# shape         rate    
#  1.818795752   0.250257971 
# (0.007975134) (0.001262041)
y.para = fitdistr(y.samp, densfun = "log-normal") 
# meanlog        sdlog   
#2.194144805   0.457245565 
#(0.001536103) (0.001086189)
z.para = fitdistr(z.samp, densfun = "log-normal") 
# meanlog        sdlog   
# 0.806226349   0.832025060 
# (0.002795164) (0.001976479)
